...
class GraphicUserInterface:
    ...
    def __init__(self, controller):
        ...
        welcome_instruction = Label(master=self.root,
                                    text='Hello! In order to proceed, please insert Images Path and press \"Predict\":')
        ...
        model_dir = Button(master=self.root, text='Browse', width=6, command=self.browse_model_file)
        model_dir.grid(row=2, column=2, sticky='W')
        ##########################################################
    ...
    def browse_model_file(self):
        ...
        model_path = filedialog.askopenfile()
    ...
    def start(self):
        ...
        modelPath = self.model_entry.get()
        self.controller = ModelController(modelPath)
